...
const Login = () => {
  ...
  const [userNameValidation,setUserNameValidation]=React.useState<any>("");
      ...
      >
        ...
        <p className="text-sm text-red-300 px-8">{passwordValidation}</p>
            ...
            <div className="p-2  mt-2 text-center space-x-4 md:block">
              <button className="mb-2 md:mb-0 bg-white px-2 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100" onClick={login}>
                Login Now
              </button>
